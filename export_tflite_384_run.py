...
# -*- coding: utf-8 -*-
"""
export_tflite_384_run.py -- Export DTLN 384-unit weights to stateful TFLite submodels.
Loads models_384_run/384_run.weights.h5 with numUnits=384, numLayer=1.
Exports model_1.tflite and model_2.tflite into models_384_run/ directory.
"""
...
# ── Paths ──────────────────────────────────────────────────────────────────
WEIGHTS_PATH  = os.path.abspath("./models_384_run/384_run.weights.h5")
OUTPUT_DIR    = os.path.abspath("./models_384_run")
...
def main():
    print("=== Exporting DTLN 384-unit Model to TFLite (Float32) ===")
