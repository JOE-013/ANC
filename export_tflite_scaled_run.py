...
# -*- coding: utf-8 -*-
"""
export_tflite_scaled_run.py -- Export DTLN 256-unit weights to stateful TFLite submodels.
Loads models_full_run/full_run_256.weights.h5 with numUnits=256, numLayer=1.
Exports model_1.tflite and model_2.tflite into models_scaled_run/ directory.
Does NOT touch any files in models_full_run/.
"""
...
# ── Paths ──────────────────────────────────────────────────────────────────
WEIGHTS_PATH  = os.path.abspath("./models_full_run/full_run_256.weights.h5")
OUTPUT_DIR    = os.path.abspath("./models_scaled_run")
...
def main():
    print("=== Exporting DTLN Scaled (256-unit) Model to TFLite (Float32, Unquantized) ===")
    ...
    # Instantiate model with 256-unit architecture
    ...
    # Quick sanity: confirm state tensors are 256-unit shaped
    print("\n=== Shape Verification ===")
    ...
    print("\nAll done. New TFLite files written to:")
    print(f"  {MODEL1_PATH}")
    print(f"  {MODEL2_PATH}")
    print("\nExisting models_full_run/ files are unchanged.")
